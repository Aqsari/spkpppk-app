<x-layoutlogin>
    ...
    <div style="height: 90%" class="flex flex-col mx-6 my-1 rounded-2xl bg-green-200 justify-center  lg:px-8">
        <div class="mb-10">
            <h1 class="mt-3 text-center text-3xl font-medium leading-9 tracking-tight text-gray-900">
                Form Pendaftaran
            </h1>
        </div>
        ...
        <div class="sm:mx-auto sm:max-w-sm">
            <form class="space-y-6" action="/register" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-2 ">
                        <input id="name" name="name" type="text" autocomplete="name" required minlength="6" value="{{ old('name') }}"
                ...
                <div>
                    ...
                    <div class="mt-2 ">
                        <input id="username" name="username" type="text" autocomplete="username" required  minlength="4" value="{{ old('username') }}"
                            class="block w-full  px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6">
                    </div>
                    @error('username')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="password" name="password" type="password" autocomplete="current-password"
                            required  minlength="4" value="{{ old('password') }}"
                            class="block w-full px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6">
                    </div>
                    @error('password')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
